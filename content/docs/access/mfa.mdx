...
### Step 1 - TOTP (Time-based One-Time Password) Setting
...
### Step 2 - WebAuthn (Web Authentication) Setting
...
<Callout type="info" title="WebAuth Support in various OS">WebAuth Support in various OS
...
## Step 3 - How to Set MFA in Perun
