...
1. Visit the [MFA Management Page](https://mfa.login.e-infra.cz), *or* go to your [e-INFRA CZ User Profile](https://profile.e-infra.cz/profile) and navigate to `Authentication` -> `Multi-Factor Autentication (MFA)` 
