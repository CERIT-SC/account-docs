...
1. Visit the [MFA Management Page](https://mfa.login.e-infra.cz), or go to your [e-INFRA CZ User Profile](https://profile.e-infra.cz/profile), then navigate to `Authentication` -> `Multi-Factor Autentication (MFA)` 
2. Click on `Manage my MFA tokens` and sign in with your identity from your home institution.
