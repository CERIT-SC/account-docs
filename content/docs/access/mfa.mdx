...
- **Windows 10+**: Use [Windows Hello](https://support.microsoft.com/en-us/windows/configure-windows-hello-dae28983-8242-bb2a-d3d1-87c9d265a5f0)
- **macOS 10.15+**: Touch ID (limited to some browsers)
- **Android 7+**: Requires screen lock (PIN, pattern, fingerprint, face)
- **iOS 14.5+**: Touch ID / Face ID
- **Linux**: Use USB-based FIDO2 tokens (e.g., YubiKey)
...
The [Touch ID](https://support.apple.com/en-in/guide/mac-help/mchl16fbf90a/mac) feature can be used (Chrome, Safari). 
